...
- The stopwatch is not started in the background
- Apple Books is opened and Clock is opened "slid over"
  - Start the stopwatch in the clock panel and slide off

### Stop

- Must slide stopwatch back to stop before running
  - No automatic stopping of the stopwatch
